    ...
    <a href="categoria.php" class="btm-novoidioma">Voltar</a>
        <div id="formulario-novoidioma">
            ...
            <form action="cadastrar-categoria.php" method="post" id="form-novoidioma">
                ...
                <input onfocus="removerElementoPorId('error-novacategoria-js')" onkeyup="transformar_texto_maiusculo(this)" type="text" name="categoria" placeholder="Nova Categoria" class="campo" required>
                <br>
