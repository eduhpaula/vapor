    ...
    <a href="idioma.php" class="btm-novoidioma">Voltar</a>
        <div id="formulario-novoidioma">
            ...
            <form action="cadastrar-idioma.php" method="post" id="form-novoidioma">
                ...
                <input onfocus="removerElementoPorId('error-novoidioma-js')" onkeyup="primeira_letra_maiuscula(this)" type="text" name="idioma" id="idioma_input" placeholder="Novo Idioma" class="campo" required>
                <br>
